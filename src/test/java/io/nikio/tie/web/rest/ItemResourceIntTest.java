...
public class ItemResourceIntTest {
    ...
    private static final Type DEFAULT_TYPE = Type.TASK;
    private static final Type UPDATED_TYPE = Type.REMINDER;
     ...
     *
     * @see io.nikio.tie.repository.search.ItemSearchRepositoryMockConfiguration
     */
    @Autowired
